...
void cfftlog_ells_double(double *x, double *fx, long N, config *config, double* ell, long Nell, double **y, double **Fy) {
	long N_original = N;
	long N_pad = config->N_pad;
	long N_extrap_low = config->N_extrap_low;
	long N_extrap_high = config->N_extrap_high;
...
void cfftlog_ells_increment_double(double *x, double *fx, long N, config *config, double* ell, long Nell, double **y, double **Fy) {
